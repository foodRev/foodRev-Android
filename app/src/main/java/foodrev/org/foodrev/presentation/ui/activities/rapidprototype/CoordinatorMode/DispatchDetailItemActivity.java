...
public class DispatchDetailItemActivity extends AppCompatActivity {

    DummyContentDispatch.DummyItemDispatch mDummyItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(DispatchDetailItemActivity.this, "Update database with new item", Toast.LENGTH_SHORT).show();
                } else {
        ...
        if (bundle != null) {
            if (bundle.getSerializable("item") != null) {
                ...
                // setText() on userName
                mDummyItem = (DummyContentDispatch.DummyItemDispatch) bundle.getSerializable("item");
            }
    ...
    void switchToEditDetailMode() {
        Toast.makeText(DispatchDetailItemActivity.this, "edit", Toast.LENGTH_SHORT).show();
