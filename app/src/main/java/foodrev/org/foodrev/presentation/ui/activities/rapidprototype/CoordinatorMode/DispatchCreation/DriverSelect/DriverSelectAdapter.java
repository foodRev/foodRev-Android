...
/**
 * Created by dastechlabs on 3/22/17.
 */

public class DriverSelectAdapter extends
   RecyclerView.Adapter<DriverSelectAdapter.ViewHolder>{
    ...
    public DriverSelectAdapter(Context context, ArrayList<DispatchDriver> dispatchDrivers) {
    ...
    @Override
    public DriverSelectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final DriverSelectAdapter.ViewHolder viewHolder, int position) {
